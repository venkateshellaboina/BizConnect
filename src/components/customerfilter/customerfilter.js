                ...
                <Container>
                    <Row>
                        <InputGroup className="filters">
                                <InputGroup.Prepend>
                                    <InputGroup.Checkbox id="now-open" name="nowOpen" checked={this.state.nowOpen} onClick={this.changeFilter}/>
                                </InputGroup.Prepend>
                    ...
                    <Row>
                        <InputGroup className="filters">
                            <InputGroup.Prepend>
                                <InputGroup.Checkbox checked={this.state.rating_4}  id="rating-4" name="rating_4" onClick={this.changeFilter}/>
                            </InputGroup.Prepend>
                    ...
                    <Row>
                        <InputGroup className="filters">
                            <InputGroup.Prepend>
                                <InputGroup.Checkbox checked={this.state.rating_3}  id="rating-3" name="rating_3" onClick={this.changeFilter}/>
                            </InputGroup.Prepend>
                    ...
                    <Row>
                        <InputGroup className="filters">
                            <InputGroup.Prepend>
                                <InputGroup.Checkbox checked={this.state.rating_2}  id="rating-2" name="rating_2" onClick={this.changeFilter}/>
                            </InputGroup.Prepend>
                    ...
                    <Row>
                        <InputGroup className="filters">
                            <InputGroup.Prepend>
                                <InputGroup.Checkbox checked={this.state.rating_1}  id="rating-1" name="rating_1" onClick={this.changeFilter}/>
                            </InputGroup.Prepend>
